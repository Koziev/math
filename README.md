...
Похожий механизм генерации датасета описан в разделе 3.2.1 Data Augmentation в статье [MRKL Systems A modular, neuro-symbolic architecture that combines large language
models, external knowledge sources and discrete reasoning](https://arxiv.org/pdf/2205.00445.pdf). 
